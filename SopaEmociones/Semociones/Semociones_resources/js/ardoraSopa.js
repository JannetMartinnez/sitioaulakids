...
var my_gradient = context.createLinearGradient(numCols*sizeCell+10 + widthWords / 2, 0, numCols*sizeCell+10 + widthWords / 2, 0 + sizeCell);
my_gradient.addColorStop(0, colorButton);my_gradient.addColorStop(1, colorBack);context.fillStyle = my_gradient;
